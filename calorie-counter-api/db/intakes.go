...
type IntakeRepository interface {
	Get(userID, intakeID string) (*models.Intake, error)
	GetAll(userID string) (models.Intakes, error)
	Create(intake *models.Intake) (*models.Intake, error)
	Update(intake *models.Intake) error
	Disable(intakeID, userID string) error
}
...
func (i *intakeRepository) Get(userID, intakeID string) (*models.Intake, error) {
...
func (i *intakeRepository) Create(intake *models.Intake) (*models.Intake, error) {
...
func (i *intakeRepository) Update(intake *models.Intake) error {
...
func (i *intakeRepository) Disable(intakeID, userID string) error {
